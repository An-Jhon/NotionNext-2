...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '人生没有那么多观众，不妨大胆一点去生活……',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Anjhon', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '但知行好事，莫要问前程', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://anjhon.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 机器学习, 读书', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'anjhon@163.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/An-Jhon', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  PRISM_THEME_PREFIX_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_PREFIX_PATH || 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-coldark-dark.css', // 代码块默认主题
  PRISM_THEME_SWITCH: process.env.NEXT_PUBLIC_PRISM_THEME_SWITCH || false, // 是否开启浅色/深色模式代码主题切换； 开启后将显示以下两个主题
  PRISM_THEME_LIGHT_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_LIGHT_PATH || 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-coldark-dark.css', // 浅色模式主题
  PRISM_THEME_DARK_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH || 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-coldark-cold.css', // 深色模式主题
  ...
  BACKGROUND_LIGHT: '#F6F8FA', // use hex value, don't forget '#' e.g #fffefc
  BACKGROUND_DARK: '#232935', // use hex value, don't forget '#'
  ...
  PREVIEW_TAG_COUNT: 8, // 首页最多展示的标签数量，0为不限制
  ...
  COMMENT_GISCUS_LOADING:
        process.env.NEXT_PUBLIC_COMMENT_GISCUS_LOADING || 'anjhon', // 你的 Giscus 載入是否漸進式載入, 預設 'lazy'
  ...
  LYKET_LIKE_BUTTON: process.env.NEXT_PUBLIC_LYKET_LIKE_BUTTON || true,
  LYKET_LIKE_ID: process.env.NEXT_PUBLIC_LYKET_LIKE_ID || 'pt_3e5b2bc03bd067b9a0167179fb25dd',
