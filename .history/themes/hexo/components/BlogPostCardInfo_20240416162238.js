  ...
  return <div className={`flex flex-col justify-between lg:p-6 p-4  ${showPageCover && !showPreview ? 'md:w-7/12 w-full md:max-h-64' : 'w-full'}`}>
        <div>
            ...
            <Link
                ...
                leading-tight font-semibold text-sky-500 hover:text-sky-400 dark:text-sky-400 dark:hover:text-sky-400`}>
            ...
            >
                <Link
                    ...
                    passHref
                    className="cursor-pointer font-light text-sm menu-link hover:text-sky-500 dark:hover:text-sky-400 transform">
                    <i className="mr-1 far fa-folder" />
                    {post.category}
                </Link>

                <TwikooCommentCount className='text-sm hover:text-sky-500 dark:hover:text-sky-400' post={post} />
            </div>}
