            ...
            {post.category && (
              <>
                <Link
                  ...
                  passHref
                  className="cursor-pointer px-2 py-1 mb-2 rounded-sm text-sm font-medium text-white border border-white hover:border-sky-500 hover:text-sky-500 duration-200 shadow-text-md">
                  {post.category}
                </Link>
              </>
            )}
